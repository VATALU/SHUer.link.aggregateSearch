...
public class DemoWord2Vec {
    private static final String TRAIN_FILE_NAME = "E:\\github workplace\\SHUer.link.aggregateSearch\\src\\main\\resources\\data\\搜狗文本分类语料库已分词.txt";
    private static final String MODEL_FILE_NAME = "E:\\github workplace\\SHUer.link.aggregateSearch\\src\\main\\resources\\data\\hanlp-wiki-vec-zh.txt";
